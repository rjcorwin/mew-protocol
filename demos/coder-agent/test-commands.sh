...
echo "Testing coder-agent with various commands..."

# Test 1: Calculation
echo "Test 1: Asking for calculation..."
node test-calc.js &
PID1=$!
wait $PID1
...
# Test 2: Create a simple test to check if agent responds
cat > test-response.js << 'EOF'
...
echo "Test 2: Checking if agent responds to greeting..."
