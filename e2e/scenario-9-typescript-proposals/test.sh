#!/usr/bin/env bash
# Scenario 9 orchestrator - run setup, checks, teardown
...
export TEMPLATE_NAME="${TEMPLATE_NAME:-scenario-9-typescript-proposals}"
export SPACE_NAME="${SPACE_NAME:-scenario-9-typescript-proposals}"
