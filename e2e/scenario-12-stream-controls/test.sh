#!/usr/bin/env bash
# Scenario 12 orchestrator - run setup, checks, teardown
...
export TEMPLATE_NAME="${TEMPLATE_NAME:-scenario-12-stream-controls}"
export SPACE_NAME="${SPACE_NAME:-scenario-12-stream-controls}"
