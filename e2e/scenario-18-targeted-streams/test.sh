#!/usr/bin/env bash
# Scenario 18 orchestrator - run setup, checks, teardown
...
export TEMPLATE_NAME="${TEMPLATE_NAME:-scenario-18-targeted-streams}"
export SPACE_NAME="${SPACE_NAME:-scenario-18-targeted-streams}"
