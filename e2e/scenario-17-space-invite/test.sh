#!/usr/bin/env bash
# Scenario 17 orchestrator - run setup, checks, teardown
...
export TEMPLATE_NAME="${TEMPLATE_NAME:-scenario-17-space-invite}"
export SPACE_NAME="${SPACE_NAME:-scenario-17-space-invite}"
