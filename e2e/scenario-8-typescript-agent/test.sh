#!/usr/bin/env bash
# Scenario 8 (TypeScript agent) orchestrator - run setup, checks, teardown
...
export TEMPLATE_NAME="${TEMPLATE_NAME:-scenario-8-typescript-agent}"
export SPACE_NAME="${SPACE_NAME:-scenario-8-typescript-agent}"
