#!/usr/bin/env bash
# Scenario 16 orchestrator - run setup, checks, teardown
...
export TEMPLATE_NAME="${TEMPLATE_NAME:-scenario-16-stream-ownership}"
export SPACE_NAME="${SPACE_NAME:-scenario-16-stream-ownership}"
