#!/usr/bin/env bash
# Scenario 11 orchestrator - run setup, checks, teardown
...
export TEMPLATE_NAME="${TEMPLATE_NAME:-scenario-11-chat-controls}"
export SPACE_NAME="${SPACE_NAME:-scenario-11-chat-controls}"
