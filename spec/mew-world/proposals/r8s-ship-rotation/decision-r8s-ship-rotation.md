...
Ships in MEW World currently have 8-directional heading but do not visually rotate to match. This creates a disconnect between the ship's logical direction and visual representation, affects collision accuracy, and prevents realistic player positioning on rotating decks.
...
**Client (`clients/mew-world/src/game/GameScene.ts`):**
...
**Types (`clients/mew-world/src/types.ts`):**
