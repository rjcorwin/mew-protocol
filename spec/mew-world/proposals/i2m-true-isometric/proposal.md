...
Convert MEW World from a "cosmetic isometric" system (isometric tiles + Cartesian physics/rendering) to a true isometric system where ALL game elements—player movement, ship rendering, rotation, collision detection, and coordinate transforms—conform to isometric projection principles.

## Problem Statement

### Current System: Mixed Coordinate System

MEW World currently uses **"cosmetic isometric"**:
...
### Primary Goal
Make MEW World visually and mechanically consistent with isometric projection throughout ALL systems.
...
- Industry Research: `spec/mew-world/proposals/w3l-wheel-steering/isometric-rotation-industry-research.md`
- Coordinate Analysis: `spec/mew-world/proposals/w3l-wheel-steering/isometric-coordinate-research.md`
- Future Ship Sprites: `spec/mew-world/proposals/w3l-wheel-steering/future-improvements.md`
