...
MEW World uses an isometric tile map, but the ship rotation and player positioning system operates in a Cartesian (orthogonal) coordinate space. This creates visual inconsistencies:
...
**File:** `clients/mew-world/src/game/GameScene.ts`
...
**File:** `clients/mew-world/src/game/GameScene.ts:397-418`
...
**File:** `clients/mew-world/src/game/GameScene.ts:485-517`
