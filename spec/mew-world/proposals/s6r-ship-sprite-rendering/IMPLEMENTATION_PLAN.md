...
Save as: `clients/mew-world/assets/blender/ship1.blend`
...
Agent creates: `clients/mew-world/scripts/render-ship-frames.py`
...
Agent creates: `clients/mew-world/scripts/assemble-sprite-sheet.sh`
...
2. Start mew-world space: `mew space up`
...
```bash
mkdir -p clients/mew-world/assets/sprites/ship_frames
mkdir -p clients/mew-world/assets/blender
mkdir -p clients/mew-world/scripts
```

#### Task A3: Create Blender Rendering Script ✓
File: `clients/mew-world/scripts/render-ship-frames.py`
- Complete Python script with error handling
- Configurable resolution, frame count
- Progress reporting

#### Task A4: Create Sprite Sheet Assembly Script ✓
File: `clients/mew-world/scripts/assemble-sprite-sheet.sh`
- ImageMagick montage command
- Error checking
- Optional cleanup of temp frames

#### Task A5: Write Blender Tutorial Guide ✓
File: `spec/mew-world/proposals/s6r-ship-sprite-rendering/BLENDER_GUIDE.md`
