...
echo -e "${YELLOW}=== Setting up STDIO MCP scenario ===${NC}";
...
export DRIVER_LOG="$TEST_DIR/logs/mcp-driver.log"
touch "$DRIVER_LOG"

export CALCULATOR_LOG="$TEST_DIR/logs/calculator.log"
touch "$CALCULATOR_LOG"
