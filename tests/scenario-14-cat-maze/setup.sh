...
SERVER_PATH="${REPO_ROOT}/packages/mew/templates/cat-maze/agents/cat-maze-server.cjs"
NARRATOR_PATH="${REPO_ROOT}/packages/mew/templates/cat-maze/agents/cat-maze-narrator.cjs"
